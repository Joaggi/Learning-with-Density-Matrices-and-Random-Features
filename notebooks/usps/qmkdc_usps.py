...
# + colab={"base_uri": "https://localhost:8080/"} executionInfo={"elapsed": 3953, "status": "ok", "timestamp": 1613169028113, "user": {"displayName": "sisyphus midas", "photoUrl": "", "userId": "13431807809642753002"}, "user_tz": 300} id="xC2A4DDR2ke2" outputId="bc4e23b0-e98a-4940-863c-edaf52d251bf"
...
# + colab={"base_uri": "https://localhost:8080/"} id="iA1l5hucdWnb" outputId="8b42e155-031c-409c-e49b-51fe271db0b4"
...
# + colab={"base_uri": "https://localhost:8080/"} executionInfo={"elapsed": 1703, "status": "ok", "timestamp": 1606083504277, "user": {"displayName": "Joseph Alejandro Gallego Mejia", "photoUrl": "https://lh3.googleusercontent.com/a-/AOh14GiRHNpVI1SA3eB-WTWWN6LPuOQg9GlITBmVJTaXloc=s64", "userId": "11469130437763358793"}, "user_tz": 300} id="CO-lHE9-mK9i" outputId="7d193189-b405-4281-ac7d-2f602e068146"
y_test_bin = tf.reshape(tf.keras.backend.one_hot(y_test, num_classes), (-1, num_classes))
